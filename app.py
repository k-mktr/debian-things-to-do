# Debian NATTD Not Another "Things To Do"!
...
# and generate a shell script for setting up a fresh Debian installation.
...
# based on the user's selections, which can be run on a Debian system to automate the
# setup process.
#
...
st.set_page_config(
    page_title="Debian Things To Do",
    page_icon="🛠️",
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={
        'Get Help': 'https://github.com/k-mktr/debian-things-to-do/issues',
        'Report a bug': "https://github.com/k-mktr/debian-things-to-do/issues",
        'About': """
        #### Not Another "Things To Do"!    
        **Debian Setup Script Builder**
        
        A Shell Script Builder for setting up Debian after a fresh install.
